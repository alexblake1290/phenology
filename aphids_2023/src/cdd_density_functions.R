...
# TODO: implement findInterval matching of original dates
...
# TODO: need to decide whether to throw away observations where CDD == 0. Currently just set those obs to min(date) - 1 day
# TODO: how to handle tails in general- generally a string of 0s to start a site_curve, and a string of the max value to end it
